...
#
# Abstract:
# This script generates the GFS Total Totals Index (gif) from the GFS Forecast data
#
...
ofile=gfs.${cycle}.ttlx.f${fh}.${rgn}.gif
#
# GLEVEL   = 850 ! 850
# GDPFUN   = omeg!wnd
# SCALE    = 4  ! 0 
...
LINE     =  
FINT     = ${pdscl}
FLINE    = 32;11;13;15;17;4;6;8
HILO     =  
HLSYM    =  
CLRBAR   = ${cbar}
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC FCST Surface Total Totals Index   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = yes
