...
#
# Abstract:
# This script generates the pr.level Vert.Velocity maps (gif) from the GFS Forecast data
#
...
ofile=gfs.${cycle}.${lvl}mb_vvel.f${fh}.${rgn}.gif
#
# GLEVEL   = $lvl ! $lvl
# GDPFUN   = omeg!wnd
# SCALE    = 4  ! 0 
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC FCST ${lvl}mb VERT.VEL (MB/SEC 10**3)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
