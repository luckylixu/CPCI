...
#
# Abstract:
# This script generates pr.level vert.velocity maps (gif format) from the GDAS Forecast data
#
...
ofile=gdas.${cycle}.${lvl}mb_vvel.f${fh}.${rgn}.gif
#
# GLEVEL   = $lvl ! $lvl
# GDPFUN   = omeg!wnd
# SCALE    = 4  ! 0 
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC FCST ${lvl}mb VERT.VEL (MB/SEC 10**3)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
