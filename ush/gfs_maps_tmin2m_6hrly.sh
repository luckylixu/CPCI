...
#
# Abstract:
# This script generates the Min. 2m Temp maps (gif format) from the GFS Forecast data 
#
...
ofile=gfs.${cycle}.tmin2m.f${fh}.${rgn}.gif
#
#
gdplot3 << EOF2
...
SKIP     = 0
SCALE    = 0
GDPFUN   = sub(tmnk06,273.15)
TYPE     = f
CONTUR   = 3/3
CINT     = 0
LINE     = 2/1/2
FINT     = -25;-20;-15;-10;0;4;8;12;16;20;24;28;30;32;34;36
FLINE    = 28;27;26;25;24;22;20;15;13;11;3-10
HILO     =
HLSYM    =
CLRBAR   = ${cbar}
WIND     =
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC ${fh}FCST 6h 2m Mnimum Air Temp (degC)   VALID 20~
TEXT     = 1./1/1/SW
CLEAR    = n
