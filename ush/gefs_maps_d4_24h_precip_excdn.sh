...
#
# Script Name: gefs_maps_d4_24h_precip_excdn.sh
#
# RFC Contact:
#
# Abstract:
# This script generates Day4 24h precip prob maps from the GEFS Forecast data
#
...
#
ofile=gefs.${cycle}.day4_24h_precip_tot_gt_${thrs}mm.${rgn}.gif
...
GVCORD   = none  
SCALE    = 2
GDPFUN   = ens_prob(gt(sub(p96m,p72m^F72),$thrs))  
TYPE     = f 
CONTUR   = 3/3
CINT     = 0
LINE     = 2/1/2
...
IJSKIP   = 0
PROJ     = ced/0;0;0
TITLE    = 1/-3/NOAA GEFS $PDY ${cycle}CYC FCST Prob. of day4 24h Precip > ${thrs}mm  VALID 20~
LATLON   = ${latln}
MAP      = 1/1/2
STNPLT   =
SATFIL   =
