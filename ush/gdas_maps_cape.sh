...
#
# Abstract:
# This script generates the CAPE maps (gif format) from the GDAS Forecast data files
#
...
#-----------------------------------------------------
#
cp ${FIXcpci}/gdas_cape_coltbl.xwp coltbl.xwp
#
...
ofile=gdas.${cycle}.cape.f${fh}.${rgn}.gif
#
#
gdplot3 << EOF2
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC FCST  BL CAPE (Joul/Kg)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = yes
