...
#
# Script Name: gefs_maps_wk1_precip_excdn.sh
#
# RFC Contact:
#
# Abstract:
# This script generates week1 precip prob maps from the GEFS Forecast data
#
...
ltln=${rgn}_ltln
latln=${!ltln}
ofile=gefs.${cycle}.wk1_precip_tot_gt_${thrs}mm.${rgn}.gif
#
...
IJSKIP   = 0
PROJ     = ced/0;0;0
TITLE    = 1/-3/NOAA GEFS $PDY 00zCYC FCST Probability of Week1 Precip > ${thrs}mm  VALID 20~
LATLON   = ${latln}
MAP      = 1/1/2
STNPLT   =
SATFIL   =
