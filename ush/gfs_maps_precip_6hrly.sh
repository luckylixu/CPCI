...
#
# Abstract:
# This script generates the  6h Total Precip maps (gif format) from the GFS Forecast data
#
...
ofile=gfs.${cycle}.6h_totp.f${fh}.${rgn}.gif
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     = 
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}cyc FCST  6h Total Precip (mm)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
