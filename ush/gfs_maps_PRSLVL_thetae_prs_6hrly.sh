...
#
# Abstract:
# This script generates the Eq.Pot.Temp maps (gif format) from the GFS Forecast data
#
...
ofile=gfs.${cycle}.${lvl}mb_eqpot_tmp.f${fh}.${rgn}.gif
#
#
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     =
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC ${fh}FCST 6h ${lvl}mb EqPot.Temp (degK)   VALID 20~
TEXT     = 1./1/1/SW
CLEAR    = n
