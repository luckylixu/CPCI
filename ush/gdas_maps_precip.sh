...
#
# Abstract:
# This script generates the Precip maps (gif format) from the GDAS Forecast data 
#
...
ofile=gdas.${cycle}.6htotp.f${fh}.${rgn}.gif
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     = 
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}cyc FCST  6h Total Precip (mm)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
