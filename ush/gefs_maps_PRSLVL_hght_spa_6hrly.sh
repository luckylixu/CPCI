...
#
# Script Name: gefs_maps_PRSLVL_hght_spa_6hrly.sh
#
# RFC Contact:
#
# Abstract:
# This script generates 500mb height spaghetti maps from the GEFS Forecast data
#
...
ltln=${rgn}_ltln
latln=${!ltln}
ofile=gefs.${cycle}.hgt500mb_spag_${cl1}_${cl2}.f${fh}.${rgn}.gif
#
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GEFS ${today} ${cyc}zCYC FCST ${lvl}mb HGT ($cl1,$cl2) Spaghetti  VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
