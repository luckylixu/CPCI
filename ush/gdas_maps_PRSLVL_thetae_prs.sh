...
#
# Abstract:
# This script generates pr.level Eq.Pot.Temp maps (gif format) from the GDAS Forecast data 
#
...
#
pdscl="240;250;260;270;280;290;300;310;320;330;340;350;360"
#
######################################################
...
ofile=gdas.${cycle}.${lvl}mb_eqpot_tmp.f${fh}.${rgn}.gif
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     =
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC ${fh}FCST 6h ${lvl}mb EqPot.Temp (degK)   VALID 20~
TEXT     = 1./1/1/SW
CLEAR    = n
...
save gdas_${rgn}_thetae_prs.nts
