...
#
# Abstract:
# This script generates the K-Index maps (gif format) from the GDAS Forecast data 
#
...
#-----------------------------------------------------
#
cp ${FIXcpci}/gdas_kindex_coltbl.xwp coltbl.xwp
#
...
ofile=gdas.${cycle}.kindex.f${fh}.${rgn}.gif
#
# GLEVEL   = 850 ! 850
# GDPFUN   = omeg!wnd
# SCALE    = 4  ! 0 
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC FCST K-INDEX   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = yes
