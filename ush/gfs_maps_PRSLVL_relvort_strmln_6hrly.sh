...
#
# Abstract:
# This script generates the rel.vort/streamlines (gif format) from the GFS Forecast data
#
...
#-----------------------------------------------------
#
cp ${FIXcpci}/gfs_vort_coltbl.xwp coltbl.xwp
#
...
ofile=gfs.${cycle}.${lvl}mb_rvort.f${fh}.${rgn}.gif
#
#
gdplot3 << EOF2
...
WIND     = 0 ! ! am31/0.2///0.5
REFVEC   = 2
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC FCST ${lvl}mb REL.VORTICITY/STREAMLINES   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
