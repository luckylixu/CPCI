...
#
# Abstract:
# This script generates pr.level Temp maps (gif format) from the GDAS Forecast data 
#
...
ofile=gdas.${cycle}.${lvl}mb_tmp.f${fh}.${rgn}.gif
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     =
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC ${fh}FCST 6h ${lvl}mb Mean Air Temp (degC)   VALID 20~
TEXT     = 1./1/1/SW
CLEAR    = n
...
LATLON   = ${latln}
MARKER   =
DEVICE  = gif|gdas.${cycle}.${lvl}mb_tmp.f${fh}.${rgn}.gif|960;720|C
LUTFIL   =
POSN     =
COLORS   =
GRDLBL   =
