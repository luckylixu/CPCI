...
#
# Abstract:
# This script generates 2m-tmin maps (gif format) from the GDAS Forecast data
#
...
ofile=gdas.${cycle}.tmin2m.f${fh}.${rgn}.gif
#
#
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     =
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC ${fh}FCST 6h 2m Mnimum Air Temp (degC)   VALID 20~
TEXT     = 1./1/1/SW
CLEAR    = n
