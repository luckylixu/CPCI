...
#
# Abstract:
# This script generates the mean 2m Temp maps (gif format) from the GFS Forecast data 
#
...
ofile=gfs.${cycle}.tmp2m.f${fh}.${rgn}.gif
#
#
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     =
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC ${fh}FCST 6h 2m Mean Air Temp (degC)   VALID 20~
TEXT     = 1./1/1/SW
CLEAR    = n
