...
#
# Abstract:
# This script generates the PWAT maps (gif format) from the GFS Forecast data 
#
...
#-----------------------------------------------------
#
cp ${FIXcpci}/gfs_pwatr_coltbl.xwp coltbl.xwp
#
...
#
pdscl="1;5;10;15;20;25;30;35;40;45;50;55;60;75"
...
ofile=gfs.${cycle}.6h_pwatr.f${fh}.${rgn}.gif
#
gdplot3 << EOF2
...
CLRBAR   = ${cbar}
WIND     = 
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}cyc FCST  6h Precipitable Water (mm)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = n
