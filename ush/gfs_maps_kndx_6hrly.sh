...
#
# Abstract:
# This script generates the GFS K-Index maps (gif format) from the GFS Forecast data files
#
...
#-----------------------------------------------------
#
cp ${FIXcpci}/gfs_kindex_coltbl.xwp coltbl.xwp
#
...
#
pdscl="20;22;24;26;28;30;32;34;38"
#
######################################################
...
ofile=gfs.${cycle}.kindex.f${fh}.${rgn}.gif
#
# GLEVEL   = 850 ! 850
# GDPFUN   = omeg!wnd
# SCALE    = 4  ! 0 
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GFS ${PDY} ${cycle}CYC FCST K-INDEX   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = yes
