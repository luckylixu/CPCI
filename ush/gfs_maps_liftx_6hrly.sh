...
#
# Abstract:
# This script generates the GFS LIFTX maps (gif format) from the GFS Forecast data files
#
...
ofile=gfs.${cycle}.liftx.f${fh}.${rgn}.gif
#
# GLEVEL   = 850 ! 850
# GDPFUN   = omeg!wnd
# SCALE    = 4  ! 0 
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GFS ${PDY} ${cyc}zCYC FCST  Sfc Lifted Index   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = yes
