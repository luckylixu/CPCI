...
#
# Script Name: gefs_maps_d1_24h_precip_excdn.sh
#
# RFC Contact:
#
# Abstract:
# This script generates Day1 24h precip probability maps from the GEFS Forecast data
#
...
#
ofile=gefs.${cycle}.day1_24h_precip_tot_gt_${thrs}mm.${rgn}.gif
...
IJSKIP   = 0
PROJ     = ced/0;0;0
TITLE    = 1/-3/NOAA GEFS $PDY ${cycle}CYC FCST Prob. of day1 24h Precip > ${thrs}mm  VALID 20~
LATLON   = ${latln}
MAP      = 1/1/2
STNPLT   =
SATFIL   =
