...
#
# Script Name: gfs_maps_liftx_mslp_precip_6hrly.sh
#
# RFC Contact:
#
# Abstract:
# This script generates the GFS LIFTX and MSLP_PRECIP maps (gif format) from the GFS Forecast data files
#
...
$USHcpci/gfs_maps_liftx_6hrly.sh $fh1 $fh2 $fh3 $fh4 ${task}_1

$USHcpci/gfs_maps_mslp_precip_6hrly.sh $fh1 $fh2 $fh3 $fh4 ${task}_2
