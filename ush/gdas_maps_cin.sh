...
#
# Script Name: gdas_maps_cinh_6hrly.sh
#
# RFC Contact:
#
# Abstract:
# This script generates the CIN maps (gif format) from the GDAS Forecast data files
#
...
#-----------------------------------------------------
#
cp ${FIXcpci}/gdas_cins_coltbl.xwp coltbl.xwp
#
...
ofile=gdas.${cycle}.cin.f${fh}.${rgn}.gif
#
#
gdplot3 << EOF2
...
WIND     = 
REFVEC   = 2
TITLE    = 1/-3/NOAA GDAS ${PDY} ${cycle}CYC FCST  180:0mb CIN (Joul/Kg)   VALID 20~
TEXT     = 1./1/1/HW
CLEAR    = yes
